...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.globalResponseMessage(RequestMethod.POST, Arrays.asList(msg201ok, erro403, erro500))
				.globalResponseMessage(RequestMethod.PUT, Arrays.asList(msg204put, erro403, erro404, erro500))
				.globalResponseMessage(RequestMethod.DELETE, Arrays.asList(msg204del, erro403, erro404, erro500))
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.will.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API de Funcionalidade 'Fale Conosco'",
				"Esta é uma API didática utilizada para instrução de alunos do Minicurso de Java e Springboot", 
				"Versão 0.1",
				"https://github.com/thaleswillreis/ContactUS_API_w_Springboot_2x",
				new Contact(
						"Thales Will", 
						"https://github.com/thaleswillreis", 
						"thaleswillreis@gmail.com"),
				"Permitido uso para estudantes e ao público em geral", 
				"https://github.com/thaleswillreis/ContactUS_API_w_Springboot_2x",
